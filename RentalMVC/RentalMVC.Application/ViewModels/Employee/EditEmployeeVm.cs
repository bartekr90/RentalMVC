...
public class EditEmployeeVm : IBaseVm, IAuditableVm, IBaseRentalVm
{
    public required string Name { get; set; }
    public int MainContactDataId { get; set; }
    public required ContactDataForListVm MainContactData { get; set; }
    public required ListContactDataVm Contacts { get; set; }
